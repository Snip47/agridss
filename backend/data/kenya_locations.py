"""All 47 Kenya counties with constituencies and wards"""
...
KENYA_LOCATIONS = {
  ...
  "Kiambu": {
    ...
    "Kabete": ["Gitaru","Muguga","Naivasha Rd","Kabete","Nyathuna"],
  ...
  "Uasin Gishu": {
    "Soy": ["Ziwa","Soy","Ziwa","Moi's Bridge","Karuna/Meibeki"],
  ...
  "Nandi": {
    "Tinderet": ["Tinderet","Chemelil/Chemase","Kapsimotwo","Kapsabet","Cheptabu"],
  ...
  "Baringo": {
    ...
    "Baringo North": ["Baringo North","Barwessa","Kabartonjo","Saimo/Kipsaraman","Saimo Soi"],
  ...
  "Nakuru": {
    ...
    "Naivasha": ["Naivasha East","Viwandani","Hells Gate","Lake View","Mai Mahiu","Maiella","Olkaria","Naivasha","Biashara"],
  ...
  "Kakamega": {
    "Lugari": ["Lugari","Lumakanda","Mautuma","Lugari","Shirugu-Mugai"],
    "Likuyani": ["Sango","Nzoia","Kongoni","Likuyani","Sango"],
    "Malava": ["Central Malava","Chemuche","East Kabras","Kabras","Butali/Chegulo","West Kabras","Manda-Shivanga"],
    "Lurambi": ["Sheywe","Butsotso East","Butsotso South","Butsotso Central","Shirere","Mahiakalo","Lgero"],
  ...
  "Bungoma": {
    ...
    "Kanduyi": ["Bukembe West","Bukembe East","Township","Khalaba","Musikoma","East Sangalo","Central Sangalo","Marakaru/Tuuti"],
  ...
  "Siaya": {
    ...
    "Gem": ["North Gem","Yala Township","Central Gem","Sidenya","Yala","East Gem","West Gem"],
    "Bondo": ["Usigu","Central Sakwa","West Sakwa","South Sakwa","Nyang'oma","Rarieda","Yimbo West"],
  ...
  "Kisumu": {
    ...
    "Kisumu West": ["South West Kisumu","Central Kisumu","Kisumu North","Shaurimoyo Kaloleni","Market Milimani","Railways Migosi"],
  ...
  "Homa Bay": {
    ...
    "Karachuonyo": ["North Karachuonyo","Central Karachuonyo","West Karachuonyo","Karachuonyo","East Karachuonyo"],
  ...
  "Migori": {
    ...
    "Nyatike": ["Kachieng","Kanyasa","North Kadem","Macalder/Kanyarwanda","Wasare","Kaler/Got Kachola","God Jope"],
  ...
  "Kisii": {
    ...
    "Bobasi": ["Masige West","Masige East","Basi Central","Nyacheki","Bassi East","Moticho","Gombao/Mpira"],
