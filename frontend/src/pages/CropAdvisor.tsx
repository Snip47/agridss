...
const CAT_EMOJI:Record<string,string> = { cereal:'🌾', legume:'🫘', vegetable:'🥬', fruit:'🍎', 'cash crop':'💰' }
const WATER_COLOR:Record<string,string> = { low:'rgba(251,191,36,0.2)', moderate:'rgba(96,165,250,0.2)', high:'rgba(34,211,238,0.2)' }
...
export default function CropAdvisor() {
  ...
  return (
    <div className="slide-up">
      ...
      {loading ? <div className="text-center py-16 text-white/50 text-lg">Loading crops...</div> : (
              ...
              <div className="flex items-center gap-3 px-5 py-4 cursor-pointer" onClick={()=>setExpanded(expanded===crop.id?null:crop.id)}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-xs text-white/35 capitalize">{crop.subcategory||crop.category}</span>
                  </div>
                </div>
                        ...
                        {crop.varieties.map((v,i)=>(
                          <div key={i} className="p-3 rounded-xl"
                            ...
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {v.maturity_days && <span className="text-xs text-white/35 ml-auto">{v.maturity_days}d</span>}
                            </div>
